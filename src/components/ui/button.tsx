...
type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  asChild?: boolean;
  variant?: "default" | "outline" | "ghost" | "link" | "gradient" | "secondary" | "destructive";
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      gradient: "bg-gradient-to-r from-cyan-500 via-blue-500 to-emerald-500 text-white shadow-lg shadow-cyan-500/25 border-0 hover:opacity-90",
    };
